...
SSA_func<-function(L,forecast_horizon_vec,gammak_generic,ht_constraint,xi=NULL,Sigma=NULL,split_grid=20,grid_size=10,with_negative_lambda=F,lower_limit_nu="rhomax")
