...
#   - Zero-crossings of Δy_t are turning points (TPs) of
#     y_t. If Δy_t is zero-mean, then SSA maximizes the duration between 
#     zero-crossings (dual formulation) and therefore y_t is maximally 
#     monotone: no other linear predictor of z_t has
